 ...
 */
Ivr.prototype.isMobile = callback => makeRequest(this.app,
  {
    auth: true,
    method: 'GET',
 ...
 */
Ivr.prototype.isEligible = callback => makeRequest(this.app,
  {
    auth: true,
    method: 'GET',
    path: '/ivr/isEligible',
 ...
 */
Ivr.prototype.serviceRequest = callback => makeRequest(this.app,
  {
    auth: true,
    method: 'POST',
 ...
 * @return {Promise/Callback} success - The boolean success within promise / callback with error
 */
Ivr.prototype.log = (callState, callback) => makeRequest(this.app,
  {
    auth: true,
    method: 'POST',
    path: '/ivr/log',
